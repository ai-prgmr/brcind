...
const Contact = () => {
  return (
    <section
      id="contact"
      className="overflow-hidden py-4 min-h-screen justify-center mx-auto"
    >
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <span className="text-md ml-3 flex flex-col items-center">
                <a
                  href="mailto:brcind@gmail.com"
                  className="bg-blue-500 hover:bg-blue-600 text-white font-bold rounded inline-block"
                >
                  <svg
              ...
              <span className="text-md ml-3 flex flex-col items-center">
                <a
                  href="tel:+919711401771"
                  className="bg-blue-500 text-white font-bold rounded inline-block"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#007bff"
